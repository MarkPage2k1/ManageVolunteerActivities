            ...
            <form method="post">
                <div class="col-md-12">
                    <div class="news-form">
                        ...
                        <input type="text" name="data_post[name]" placeholder="Chuẩn bị phương tiện, ..." id="name" value="<?php $dataTask = $data['data_task']; echo $dataTask['name'] ?>">
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <textarea style="background-color: #F1F1F1;" name="data_post[description]" id="description" class="form-control" cols="30"><?= $dataTask['description'] ?></textarea>
                    <script>
