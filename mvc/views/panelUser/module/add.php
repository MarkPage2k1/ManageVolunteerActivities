            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="name" class="form-control" name="data_post[name]">
                    </div>
                    <div class="form-group">
                        <label for="content">Lien ket</label>
                        <input type="text" id="link" class="form-control" name="data_post[link]">
                    </div>
                    <div class="form-group">
                        <label for="content">Controller</label>
                        <input type="text" id="controller" class="form-control" name="data_post[controller]">
                    </div>
                    <div class="form-group">
                        <label for="content">Icon</label>
                        <input type="text" id="icon" class="form-control" name="data_post[icon]">
                    </div>
                    <div class="form-group">
                        <label for="category">Hien thi</label>
                        <input type="checkbox" name="data_post[publish]" id="publish" checked>
                    </div>
